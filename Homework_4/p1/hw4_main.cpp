...
void createSquare(void)
{
	...
	colors[0] = 0.0; colors[1] = 0.0; colors[2] = 0.0; // Bottom left corner

	vertices[5] = -0.5; vertices[6] = 0.5; vertices[7] = 0.5; // Top left corner
	vertices[8] = 0.0; vertices[9] = 1.0; //Texture Vertices
	colors[3] = 0.0; colors[4] = 0.0; colors[5] = 0.0; // Top left corner

	vertices[10] = 0.5; vertices[11] = 0.5; vertices[12] = 0.5; // Top Right corner
	vertices[13] = 1.0; vertices[14] = 1.0; //Texture Vertices
	colors[6] = 0.0; colors[7] = 0.0; colors[8] = 0.0; // Top Right corner

	vertices[15] = 0.5; vertices[16] = -0.5; vertices[17] = 0.5; // Bottom right corner
	vertices[18] = 1.0; vertices[19] = 0.0; //Texture Vertices
	colors[9] = 0.0; colors[10] = 0.0; colors[11] = 0.0; // Bottom right corner

	vertices[20] = -0.5; vertices[21] = -0.5; vertices[22] = 0.5; // Bottom left corner
	vertices[23] = 0.0; vertices[24] = 0.0; //Texture Vertices
	colors[12] = 0.0; colors[13] = 0.0; colors[14] = 0.0; // Bottom left corner

	vertices[25] = 0.5; vertices[26] = 0.5; vertices[27] = 0.5; // Top Right corner
	vertices[28] = 1.0; vertices[29] = 1.0; //Texture Vertices
	colors[15] = 0.0; colors[16] = 0.0; colors[17] = 0.0; // Top Right corner
	...
	delete[] colors; // And do the same to our colors.
	...
	string imgPath = "C:\\Users\\Arlo\\Desktop\\Stuff\\IAState Class Materials\\557\\Projects\\Homework_4\\p1\\test_texture.bmp";
	unsigned char* texPointer = ImgLoader::Load(imgPath); //Loading the image and getting a pointer.
	...
	/*//testing: this should load a checkerboard pattern.
	float pixels[] = {
	...
	*/
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, 255, 255, 0, GL_BGR, GL_UNSIGNED_BYTE, texPointer);
	//Testline - this rendered a 2x2 checkerboard.
